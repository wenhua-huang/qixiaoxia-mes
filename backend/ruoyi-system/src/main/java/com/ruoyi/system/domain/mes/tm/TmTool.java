...
public class TmTool extends BaseEntity
{
    ...
    /** 工装夹具类型ID(关联qxx_tm_tool_type) */
    @Excel(name = "工装夹具类型ID(关联qxx_tm_tool_type)")
    ...
    /** 可用数量(总数量减去使用中和保养中的数量) */
    @Excel(name = "可用数量(总数量减去使用中和保养中的数量)")
    ...
    /** 状态:STORE-在库,USING-使用中,MAINTENANCE-保养中,SCRAPPED-报废 */
    @Excel(name = "状态:STORE-在库,USING-使用中,MAINTENANCE-保养中,SCRAPPED-报废")
