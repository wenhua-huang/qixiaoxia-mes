...
CREATE TABLE IF NOT EXISTS qxx_wm_warehouse (
  ...
  client_id         bigint(20)      default null               comment '客户仓归属客户ID(ownership_type=CUSTOMER时必填)',
  vendor_id         bigint(20)      default null               comment '供应商仓归属供应商ID(ownership_type=SUPPLIER时必填)',
