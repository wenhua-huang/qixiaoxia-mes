...
values('节假日设置', '3', '1', 'holiday', 'mes/cal/holiday/index', 1, 0, 'C', '0', '0', 'mes:cal:holiday:list', '#', 'admin', sysdate(), '', null, '节假日设置菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('节假日设置修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'mes:cal:holiday:edit',         '#', 'admin', sysdate(), '', null, '');
