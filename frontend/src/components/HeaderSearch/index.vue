<template>
  <div class="header-search">
    <AppIcon class-name="search-icon" icon-class="search" @click.stop="click" />
    <el-dialog
      v-model="show"
      width="600"
      @close="close"
      ...
      <div class="result-wrap">
        <el-scrollbar>
          ...
          <template v-if="options.length > 0">
            ...
            >
              <div class="left">
                <AppIcon class="menu-icon" :icon-class="item.icon" />
              </div>
              ...
              <AppIcon icon-class="enter" v-show="index === activeIndex" />
            </div>
          </template>
