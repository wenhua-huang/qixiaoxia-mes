...
CREATE TABLE IF NOT EXISTS `qxx_pro_exception` (
  ...
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OPEN' COMMENT '状态 OPEN待处理/PROCESSING处理中/CLOSED已关闭',
  ...
  `scene_images` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '现场照片(MinIO URL逗号串)',
