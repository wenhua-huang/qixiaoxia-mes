...
public class WmMaterialStock extends BaseEntity
{
    ...
    public BigDecimal getQuantityOnhand2() { return quantityOnhand2; }
    public void setQuantityOnhand2(BigDecimal v) { this.quantityOnhand2 = v; }
