...
CREATE TABLE IF NOT EXISTS `qxx_pro_task` (
  ...
  `is_exception` char(1) COLLATE utf8mb4_unicode_ci DEFAULT 'N' COMMENT '是否异常(返工/补做)任务 Y/N',
  `exception_id` bigint DEFAULT NULL COMMENT '来源异常单ID',
  `exception_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源异常单号',
  `origin_task_id` bigint DEFAULT NULL COMMENT '原工序任务ID(-E序号计数用)',
  PRIMARY KEY (`task_id`),
  KEY `idx_factory_id` (`factory_id`),
  KEY `idx_outsource_factory_id` (`outsource_factory_id`),
  ...
  KEY `idx_origin` (`origin_task_id`)
) ENGINE=InnoDB AUTO_INCREMENT=304 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生产任务/排产表';

-- V157 生产异常单（快照对齐 V157）
CREATE TABLE IF NOT EXISTS `qxx_pro_exception` (
  `exception_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `factory_id` bigint NOT NULL COMMENT '工厂ID',
  `exception_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '异常单号(EX20260902-014)',
  `exception_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '异常类型 QUALITY质量数量/MATERIAL缺料/DELAY进度延迟/RETURN客户退货',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OPEN' COMMENT '状态 OPEN待处理/PROCESSING处理中/CLOSED已关闭/VOID已作废',
  `responsible_party` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '责任方 FACTORY本厂/SUPPLIER供应商/CUSTOMER客户/PENDING待定',
  `workorder_id` bigint DEFAULT NULL COMMENT '工单ID',
  `workorder_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工单编码快照',
  `workorder_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工单名称快照',
  `task_id` bigint DEFAULT NULL COMMENT '工序任务ID',
  `task_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '任务编号快照',
  `process_id` bigint DEFAULT NULL COMMENT '工序ID',
  `process_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工序编码快照',
  `process_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工序名称快照',
  `target_type` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'TASK' COMMENT '关联对象类型(预留:二期挂销售订单)',
  `target_id` bigint DEFAULT NULL COMMENT '关联对象ID',
  `target_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联对象编号',
  `reporter_id` bigint DEFAULT NULL COMMENT '上报人用户ID',
  `reporter_name` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '上报人账号快照',
  `occur_time` datetime DEFAULT NULL COMMENT '异常发生时间',
  `impact_quantity` decimal(14,2) DEFAULT NULL COMMENT '影响数量',
  `description` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '异常情况说明',
  `scene_images` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '现场照片(MinIO URL逗号串,最多9张)',
  `quality_subclass` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '质量小类 BROKEN做坏了/SHORT做少了',
  `usable_quantity` decimal(14,2) DEFAULT NULL COMMENT '可使用数量',
  `need_rework` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '是否需要返工 Y/N',
  `item_id` bigint DEFAULT NULL COMMENT '缺料物料ID',
  `item_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '缺料物料编码',
  `item_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '缺料物料名称',
  ...
  `delay_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '延迟原因',
  `return_quantity` decimal(14,2) DEFAULT NULL COMMENT '退货数量',
  `return_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退货原因',
  `customer_accept_rework` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户是否接受返工 Y/N',
  `conclusion` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理结论',
  `resolve_type` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '出口动作 REWORK返工/REMAKE补做/PURCHASE补料采购/RESCHEDULE顺延/SCRAP报废/CONCESSION让步接收/REFUND退款结单',
  `resolve_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '选出口处理人',
  `resolve_time` datetime DEFAULT NULL COMMENT '选出口时间',
  `target_doc_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理产生单据类型 TASK/PUR_ORDER',
  `target_doc_id` bigint DEFAULT NULL COMMENT '处理产生单据ID',
  `target_doc_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理产生单据编号',
  `scrap_quantity` decimal(14,2) DEFAULT NULL COMMENT '报废数量',
  `close_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关闭人',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生产异常单';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
-- 对齐 V65 重建后的生产结构（V64/V65 在测试 baseline=136 之下不重放）；
-- V142 再在其上补 team_id/team_code/team_name 并建 (clock_in_time, team_id) 索引。
...
CREATE TABLE IF NOT EXISTS `qxx_wm_product_sales` (
  ...
  `total_quantity` decimal(14,4) DEFAULT '0.0000' COMMENT '出库总数量',
  `posted_quantity` decimal(14,4) DEFAULT '0.0000' COMMENT '已过账出库量(部分出库追踪)',
  `shipped_quantity` decimal(16,4) DEFAULT '0.0000' COMMENT '已发运量',
  `ship_status` varchar(20) DEFAULT 'UN_SHIPPED' COMMENT '发运状态:UN_SHIPPED-未发运,PARTIAL_SHIPPED-部分发运,SHIPPED-已发运,RECEIVED-已签收',
  ...
  `sales_order_id` bigint DEFAULT NULL COMMENT '销售订单ID(关联qxx_sal_order)',
  `sales_order_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '销售订单编码',
...
CREATE TABLE IF NOT EXISTS `qxx_wm_product_sales_line` (
  ...
  `factory_id` bigint NOT NULL COMMENT '工厂ID(关联qxx_md_factory)',
  `sales_id` bigint NOT NULL COMMENT '出库单ID(关联qxx_wm_product_sales)',
  `sales_order_line_id` bigint DEFAULT NULL COMMENT '销售订单行ID(关联qxx_sal_order_line)',
  `item_id` bigint NOT NULL COMMENT '物料ID(关联qxx_md_item)',
  `item_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '物料编码',
  `item_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '物料名称',
  `specification` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规格型号',
  ...
  `quantity_posted` decimal(14,4) DEFAULT '0.0000' COMMENT '已过账出库量(部分出库追踪)',
  ...
  `available_qty` decimal(14,4) DEFAULT NULL COMMENT '本仓可用量(建议快照)',
  `location_id` bigint DEFAULT NULL COMMENT '库区ID',
  `area_id` bigint DEFAULT NULL COMMENT '库位ID',
  `remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '备注',
  `create_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
...
CREATE TABLE IF NOT EXISTS `qxx_wm_rt_issue_line` (
  ...
  `rt_id` bigint NOT NULL COMMENT '退料单ID(关联qxx_wm_rt_issue)',
  `issue_id` bigint DEFAULT NULL COMMENT '原领料单ID(关联qxx_wm_issue_header)',
  `issue_line_id` bigint DEFAULT NULL COMMENT '原领料明细行ID',
  `item_id` bigint NOT NULL COMMENT '物料ID(关联qxx_md_item)',
  `item_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '物料编码',
  `item_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '物料名称',
  `specification` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规格型号',
  ...
  `quantity_rted` decimal(14,4) DEFAULT '0.0000' COMMENT '已退料累计',
  `batch_id` bigint DEFAULT NULL COMMENT '批次ID',
  `batch_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '批次编码',
  `warehouse_id` bigint NOT NULL COMMENT '仓库ID',
  `location_id` bigint DEFAULT NULL COMMENT '库区ID',
...
CREATE TABLE IF NOT EXISTS `qxx_wm_warehouse` (
  ...
  `ownership_type` varchar(20) NOT NULL DEFAULT 'PUBLIC' COMMENT '归属类型:PUBLIC-公共仓,CUSTOMER-客户仓,SUPPLIER-供应商仓',
  `client_id` bigint DEFAULT NULL COMMENT '客户仓归属客户ID(ownership_type=CUSTOMER时必填)',
  `vendor_id` bigint DEFAULT NULL COMMENT '供应商仓归属供应商ID(ownership_type=SUPPLIER时必填)',
...
-- qxx_wm_outsource_order: V100 建表迁移在测试 baseline(136) 之下被跳过，
-- 此处按生产库当前形态（V100 + V104/V105/V109/V113 + V141）补建，
-- 否则 V141 的幂等 ALTER 在 IT 容器里报 1146。
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `qxx_wm_outsource_order` (
  `order_id` bigint NOT NULL AUTO_INCREMENT COMMENT '外协订单ID',
