    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <div class="welcome-banner">
          <h2>欢迎使用 企小侠 · MES 智能制造执行系统</h2>
          <p>文化纸盒行业专属解决方案 — 版本 v{{ version }}</p>
        </div>
      </el-col>
    </el-row>

    <!-- 快捷功能模块 -->
    <el-row :gutter="16" class="mes-modules">
      ...
      <el-col :xs="24" :md="12">
        <el-card class="tech-card">
          ...
          <div class="stats-grid">
            <div class="stat-item">
              <span class="stat-value" style="color:#1a3c5e">--</span>
              <span class="stat-label">今日工单</span>
            </div>
            <div class="stat-item">
              <span class="stat-value" style="color:#30B08F">--</span>
              <span class="stat-label">完成率</span>
            </div>
            <div class="stat-item">
              <span class="stat-value" style="color:#c9a96e">--</span>
              <span class="stat-label">在制品</span>
            </div>
            <div class="stat-item">
              <span class="stat-value" style="color:#F56C6C">--</span>
              <span class="stat-label">异常工单</span>
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p><strong>系统名称：</strong>企小侠文化纸盒MES系统</p>
            <p><strong>当前版本：</strong>v{{ version }}</p>
            <p><strong>运行环境：</strong>Spring Boot 4.0.3 + JDK 17</p>
            <p><strong>前端框架：</strong>Vue 3 + TypeScript + Element Plus</p>
            <p><strong>移动端：</strong>UniApp Vue3 多端适配</p>
            <p><strong>开发团队：</strong>企小侠科技</p>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
          ...
          <div class="body">
            <el-timeline>
              <el-timeline-item>
                ...
                <p style="color:#909399;margin:4px 0 0">物料、BOM、工艺路线、工作中心</p>
              </el-timeline-item>
              <el-timeline-item>
                <strong>仓储管理 (WM)</strong>
                <p style="color:#909399;margin:4px 0 0">入库、出库、库存盘点、库位管理</p>
              </el-timeline-item>
              <el-timeline-item>
                <strong>生产管理 (PRO)</strong>
                <p style="color:#909399;margin:4px 0 0">工单排程、工序流转、报工统计</p>
              </el-timeline-item>
              <el-timeline-item>
                <strong>质量管理 (QC)</strong>
                <p style="color:#909399;margin:4px 0 0">IQC/IPQC/OQC、不良品追踪</p>
              </el-timeline-item>
              <el-timeline-item>
                <strong>设备管理 & 报表</strong>
                <p style="color:#909399;margin:4px 0 0">设备台账、OEE分析、生产报表</p>
              </el-timeline-item>
            </el-timeline>
          </div>
        </el-card>
...
// MES 功能模块导航
const modules = [
  { key: 'md', name: '基础数据', desc: '物料 · BOM · 工艺', icon: 'table', color: '#1a3c5e' },
  { key: 'wm', name: '仓储管理', desc: '入库 · 出库 · 盘点', icon: 'tree-table', color: '#2a5a8a' },
  { key: 'pro', name: '生产管理', desc: '工单 · 流转 · 报工', icon: 'component', color: '#30B08F' },
  { key: 'qc', name: '质量管理', desc: '检验 · 不良品', icon: 'validCode', color: '#c9a96e' },
  { key: 'dv', name: '设备管理', desc: '台账 · 保养 · 维修', icon: 'monitor', color: '#5a7ea0' },
  { key: 'report', name: '报表分析', desc: '生产 · 质量 · 库存', icon: 'chart', color: '#1a3c5e' },
]

function goModule(path: string): void {
  // 跳转到对应模块首页，需要后端先配置菜单路由
  router.push(`/mes/${path}`).catch(() => {})
}
</script>
  ...
  .mes-modules {
    ...
    .module-card {
      ...
      &:hover {
        ...
        box-shadow: 0 8px 25px rgba(12, 215, 189, 0.2);
        border-color: #0cd7bd;
      }
