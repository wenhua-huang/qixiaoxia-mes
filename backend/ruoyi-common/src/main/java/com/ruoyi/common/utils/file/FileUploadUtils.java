...
public class FileUploadUtils
{
    ...
    public static final String uploadMinio(MultipartFile file) throws IOException
    {
        try
        {
            return uploadMinio(file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
     ...
     * @throws IOException
     */
    public static final String uploadMinio(MultipartFile file, String[] allowedExtension) throws IOException
    {
        try
        {
            int fileNameLength = Objects.requireNonNull(file.getOriginalFilename()).length();
            ...
            return MinioUtil.uploadFile(MinioUtil.getBucketName(), fileName, file);
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
