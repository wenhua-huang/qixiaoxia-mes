...
values('采购订单行', 2006, '1', 'line', 'mes/pur/order-line/index', 1, 0, 'C', '0', '0', 'mes:pur:order-line:list', '#', 'admin', sysdate(), '', null, '采购订单行菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('采购订单行修改', @parentId, 2006,  '#', '', 1, 0, 'F', '0', '0', 'mes:pur:order-line:edit',         '#', 'admin', sysdate(), '', null, '');
