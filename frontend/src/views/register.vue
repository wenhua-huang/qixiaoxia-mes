    ...
    <el-form ref="registerRef" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item prop="username">
        <el-input 
          ...
          placeholder="账号"
        >
          <template #prefix><AppIcon icon-class="user" class="el-input__icon input-icon" /></template>
        </el-input>
      </el-form-item>
      <el-form-item prop="password" :rules="registerPwdValidator">
        ...
        >
          <template #prefix><AppIcon icon-class="password" class="el-input__icon input-icon" /></template>
        </el-input>
      </el-form-item>
      ...
      <el-form-item prop="code" v-if="captchaEnabled">
        <el-input
          ...
          @keyup.enter="handleRegister"
        >
          <template #prefix><AppIcon icon-class="validCode" class="el-input__icon input-icon" /></template>
        </el-input>
